    ...
    theme: {
        extend: {
            colors: {
                ...
                "timeline-heading": "#1a1a1a",
                "timeline-bg": "#ffffff",
                "timeline-border": "#e3d3f2",
                "timeline-accent": "#724e99",
                "timeline-icon-fg": "#ffffff",
                "timeline-phase": "#724e99",
                "timeline-text": "#1a1a1a",
                "timeline-detail": "#724e99",
                "timeline-line": "#724e99",
                "timeline-card": "#eadff5",
                "timeline-card-border": "#e3d3f2",
            },
            animation: {
